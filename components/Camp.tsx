  ...
  return (
    ...
    >
      <div className="flex h-full w-100 flex-col items-start justify-between p-6 lg:px-20 lg:py-10  ">
        ...
        {/* ! People images and peopleJoined (on the bottom) */}
  ...
  return (
    <section className=" 2xl: max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] lg:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
